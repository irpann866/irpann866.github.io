export default function mobile() {
    return (
        ...
        <div className="w-full h-full bg-white">
            <div className="text-black font-semibold  text-3xl pb-2 text-center pt-5">Mobile Design</div>
        <div className="container px-6 mx-auto py-5 bg-white sm:flex ">
            <div className=" rounded-md shadow-lg overflow-hidden mb-10">
                <img src="images/mobile2.jpg"  className="w-full h-1/2" alt="gambar" />
            ...
            <div className=" rounded-md shadow-lg overflow-hidden mb-10 ml-2">
                <img src="images/mobile3.jpg"  className="w-full h-1/2" alt="gambar" />
                <div className="px-6 py-4">
            ...
            <div className=" rounded-md shadow-lg overflow-hidden mb-5 ml-2">
                <img src="images/mobile5.jpg"  className="w-full h-1/2" alt="gambar" />
                <div className="px-6 py-4">
